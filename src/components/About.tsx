        ...
        <div className="flex flex-col gap-8" style={{ md: { flexDirection: 'row' } } as any}>
          ...
          >
            ...
            <div style={{ fontSize: '1.1rem', color: 'var(--text-muted)' }}>
              ...
              <p>
                Currently, I am the <strong>Co-Founder, CTO, and CFO</strong> at <a href="https://github.com/Bharath-Aadhya-Intelligence" target="_blank" rel="noreferrer" style={{ color: 'var(--accent)', textDecoration: 'underline' }}>Bharath Aadhya Intelligence</a>, where I oversee technical vision, financial strategy, and project delivery. I lead the development of innovative AI-driven solutions and high-impact client-based applications, focusing on building accessible, inclusive digital experiences that solve complex, real-world problems.
              </p>
            </div>
          </motion.div>
